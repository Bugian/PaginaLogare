...
import com.example.paginaLogare.useri.webClient.UserWebClient;
...
//            // 2. Create a new user
//            log.info("Creating a new user...");
//            User newUser2 = new User("newuser2", "password", "newuser2@example.com");
//            client.create(newUser2);
//            log.info("User created: {}", newUser2);
//
//            // 2. Create a new user
//            log.info("Creating a new user...");
//            User newUser3 = new User("newuser3", "password", "newuser3@example.com");
