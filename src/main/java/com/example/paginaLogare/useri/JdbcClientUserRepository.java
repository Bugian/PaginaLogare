...
//        var updated = jdbcClient.sql("INSERT INTO users (username, password, email, account_created_on) VALUES (?, ?, ?, ?)")
...
//        return jdbcClient.sql("SELECT id, username, password, email, account_created_on FROM users WHERE id = :id")
//                .param("id", id)
//                .query(User.class)
//                .optional();
//    }
...
//        return jdbcClient.sql("SELECT id, username, password, email, account_created_on FROM users WHERE email = :email")
//                .param("email", email)
//                .query(User.class)
//                .first();
//    }
...
//        return jdbcClient.sql("SELECT id, username, password, email, account_created_on FROM users WHERE username = :username")
